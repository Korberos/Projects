...
void StringCanBeSignedChar(char* string, StringCanBeBitflag& flag);
void StringCanBeSignedShort(char* string, StringCanBeBitflag& flag);
void StringCanBeSignedInt(char* string, StringCanBeBitflag& flag);
void StringCanBeSignedLongInt(char* string, StringCanBeBitflag& flag);
void StringCanBeUnsignedChar(char* string, StringCanBeBitflag& flag);
void StringCanBeUnsignedShort(char* string, StringCanBeBitflag& flag);
void StringCanBeUnsignedInt(char* string, StringCanBeBitflag& flag);
void StringCanBeUnsignedLongInt(char* string, StringCanBeBitflag& flag);
void StringCanBeFloat(char* string, StringCanBeBitflag& flag);
void StringCanBeDouble(char* string, StringCanBeBitflag& flag);

StringCanBeBitflag StringCanBe(char* string)
{
...
void StringCanBeSignedChar(char* string, StringCanBeBitflag& flag)
{
	...
	char* positive_string = negative ? &string[1] : string;
...
bool StringToSignedChar(char* string, signed char& signed_char_val)
{
...
bool StringToSignedShort(char* string, signed short& signed_short_val)
{
...
bool StringToSignedInt(char* string, signed int& signed_int_val)
{
...
bool StringToSignedLongInt(char* string, signed long int& signed_long_int_val)
{
...
bool StringToUnsignedChar(char* string, unsigned char& unsigned_char_val)
{
...
bool StringToUnsignedShort(char* string, unsigned short& unsigned_short_val)
{
...
bool StringToUnsignedInt(char* string, unsigned int& unsigned_int_val)
{
...
bool StringToUnsignedLongInt(char* string, unsigned long int& unsigned_long_int_val)
{
...
bool StringToFloat(char* string, float& float_val)
{
...
bool StringToDouble(char* string, double& double_val)
{
