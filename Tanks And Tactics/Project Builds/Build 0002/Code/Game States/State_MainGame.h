...
public:
	...
	bool					Initialize(float* fpTimeSlice);
	bool					Input(void);
...
private:
	...
	int						EffectPhaseUpdate(float ElapsedTime);
	int						BattlePhaseUpdate(float ElapsedTime);
	int						ActionPhaseUpdate(float ElapsedTime);
