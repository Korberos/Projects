...
GLint gltWriteTGA(const char *szFileName)
    ...
    //pFile = fopen(szFileName, "wb"); // NOTE: Replaced this with fopen_s
...
GLbyte *gltLoadTGA(const char *szFileName, GLint *iWidth, GLint *iHeight, GLint *iComponents, GLenum *eFormat)
    ...
    *iComponents = GL_RGB8;
    ...
    // pFile = fopen(szFileName, "rb"); // NOTE: Replaced this with fopen_s
...
bool bLoadShaderFile(const char *szFile, GLhandleARB shader)
    ...
    // fp = fopen(szFile, "r"); // Note: Replaced this with fopen_s
	fopen_s(&fp, szFile, "r");
    if(fp != NULL)
		{
