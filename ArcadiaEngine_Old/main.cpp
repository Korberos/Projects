...
#include "Engine/WinsockWrapper/WinsockWrapper.h"
#include "Engine/DebugConsole.h"
#include "Engine/FontController.h"
#include "Engine/RandomNumbers.h"
#include "Engine/DialogSystem/MenuGUI.h"
#include "Engine/DialogSystem/Elements/MenuElement_Frame.h"
#include "Engine/DialogSystem/Elements/MenuElement_CheckBox.h"
#include "Engine/DialogSystem/Elements/MenuElement_TextureButton.h"
#include "Engine/DialogSystem/Elements/MenuElement_TextButton.h"
#include "Engine/DialogSystem/Elements/MenuElement_DropDown.h"
#include "Engine/DialogSystem/Elements/MenuElement_TextBlock.h"
#include "Engine/DialogSystem/Elements/MenuElement_ListBox.h"
#include "Engine/DialogSystem/Elements/MenuElement_EditBox.h"
#include "Engine/DialogSystem/Elements/MenuElement_Texture.h"
...
int main( int argc , char* argv[] )
{
	...
	std::string window_name( "Arcadia Engine - v01.00.00" );
#ifdef _DEBUG
	window_name += " - DEBUG";
#else
	window_name += " - RELEASE";
